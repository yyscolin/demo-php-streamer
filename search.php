...
?>
  ...
  <title>Search - Demo PHP Streamer</title>
  <style>
    #search-form {
      margin-top: 32px;
    }
...
?>
  ...
  <div id='main-block'>
    <form id='search-form'>
      <select name='type'>
        <option value='star'<?php if ($type == 'star') echo "selected='selected'"; ?>>Stars</option>
        <option value='vid'<?php if ($type == 'vid') echo "selected='selected'"; ?>>Video</option>
      </select>
